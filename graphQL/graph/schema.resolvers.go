...
func (r *categoryResolver) Courses(ctx context.Context, obj *model.Category) ([]*model.Course, error) {
	...
	var coursesModel = make([]*model.Course, len(courses))
	for i := range coursesModel {
		coursesModel[i] = &model.Course{
			ID:          courses[i].ID,
			Name:        &courses[i].Name,
...
func (r *queryResolver) Categories(ctx context.Context) ([]*model.Category, error) {
	...
	var categoriesModel = make([]*model.Category, len(categories))
	for i := range categoriesModel {
		categoriesModel[i] = &model.Category{
			ID:          categories[i].ID,
